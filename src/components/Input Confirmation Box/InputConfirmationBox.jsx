...
import "./InputConfirmationBox.css";
...
function SimpleDialog({
  ...
  return (
    <Dialog onClose={handleClose} open={open}>
      <DialogTitle>Are you sure you want to discard this ?</DialogTitle>
...
function InputConfirmationBox({ onItemClick, dataValue, modalClose, index }) {
